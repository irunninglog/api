...
@EndpointVerticle(endpoint = Endpoint.API_PING, request = IPingRequest.class, response = IPingResponse.class)
public class ApiPingVerticle extends AbstractRequestResponseVerticle<IPingRequest, IPingResponse> {

    private final IPingService pingService;

    public ApiPingVerticle(IFactory factory, IMapper mapper, IPingService pingService) {
