...
final class MockDeleteWorkoutResponse implements IDeleteWorkoutResponse<MockDeleteWorkoutResponse> {
    ...
    @Override
    public MockDeleteWorkoutResponse setStatus(ResponseStatus status) {
        this.status = status;
        return this;
    }
    ...
    @Override
    public MockDeleteWorkoutResponse setBody(IWorkout body) {
        this.body = body;
        return this;
    }
